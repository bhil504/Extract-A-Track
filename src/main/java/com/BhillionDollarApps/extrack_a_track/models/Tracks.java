...
public class Tracks {
    ...
    private Float rms;
    private String s3Key; // S3 key for the stored file path
 ...
 // Fields for analysis and metadata
    private String songKey; // Detected key
    @Lob
    ...
    public boolean isValidFile() {
        ...
        return file.getSize() <= 50 * 1024 * 1024 && (file.getContentType().equals("audio/mpeg") || file.getContentType().equals("audio/wav"));
    }
